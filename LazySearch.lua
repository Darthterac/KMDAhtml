...
local function CreateSearchFrame()
    ...
    local headers = {
        { text = "NAME",   width = 185, point = "TOPLEFT", refFrame = "searchFrame", offsetX = 20,  offsetY = -68 },
        { text = "RANK",   width = 185, point = "TOPLEFT", refFrame = "searchFrame", offsetX = 163, offsetY = -68 },
        { text = "STATUS", width = 185, point = "TOPLEFT", refFrame = "searchFrame", offsetX = 272, offsetY = -68 },
    }
    ...
    scrollFrame:SetSize(searchFrame:GetWidth() - 10, searchFrame:GetHeight() - 98)
...
--/run CMSF=CommunitiesFrame.MemberList.ScrollBox:GetFrames(); print(CMSF)
